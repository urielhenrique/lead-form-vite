...
export default function Layout({ children }) {
  ...
  const whatsappUrl =
    "https://wa.me/5531999587412?text=Ol%C3%A1!%20Gostaria%20de%20agendar%20uma%20consulta%20com%20um%20especialista%20da%20Gomides%20%26%20Gomes.%20Vim%20pelo%20site.";

  useEffect(() => {
    // Configurações e Integração do Chatwoot
    ...
    (function (d, t) {
      var BASE_URL = "https://chat.rpholding.com.br";
      ...
      g.onload = function () {
        window.chatwootSDK.run({
          websiteToken: "JfmrdMvNYS6ASjAoqjse92hu",
          baseUrl: BASE_URL,
        });
        // Comando para abrir o balão automaticamente após 2 segundos
        setTimeout(() => {
          if (window.$chatwoot) {
          ...
          <div className="flex justify-between items-center h-20">
            ...
            <nav className="hidden md:flex items-center gap-8">
              ...
              <Button
                ...
                className="bg-[#b49b67] hover:bg-[#9a8455] text-white rounded-none px-6 font-medium"
              >
                Agendar Consulta
              </Button>
            </nav>
        ...
        {isMenuOpen && (
          ...
          >
            <div className="px-4 py-6 space-y-4 flex flex-col">
              ...
              <Button
                onClick={() => window.open(whatsappUrl, "_blank")}
                className="bg-[#b49b67] text-white w-full rounded-none"
              >
                Agendar Consulta
              </Button>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-slate-400 max-w-sm leading-relaxed">
                ...
                Condominial, Trabalhista, Bancário e Previdenciário.
              </p>
            </div>
              ...
              <ul className="space-y-3 text-slate-300">
                ...
                <li className="flex items-center gap-3">
                  <a
                    ...
                    className="hover:text-white transition-colors"
                  >
                    <FaWhatsapp className="w-5 h-5 text-[#b49b67]" />
                  </a>
                ...
                <li className="flex items-center gap-3">
                  <a
                    ...
                    className="hover:text-white transition-colors"
                  >
                    <Instagram className="w-5 h-5 text-[#b49b67]" />
                  </a>
